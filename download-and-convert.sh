...
then
  ...
  wget -O data/$NUMBER.zip http://www.eea.europa.eu/data-and-maps/data/clc-2006-vector-data-version-1/$NUMBER-$NAME/clc06_c$NUMBER.zip/at_download/file
fi
...
xsltproc tag.xslt osm/$NUMBER.osm > tagged/$NUMBER.osm
